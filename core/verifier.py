...
def check_name(display_name: str, username: str) -> dict:
    ...
    try:
        result = _call_ai([
            {"role": "system", "content": NAME_CHECK_PROMPT},
            {"role": "user", "content": f"Display name: {display_name}\nUsername: @{username or '(none)'}"},
        ])
...
def check_spam(message_content: str) -> dict:
    ...
    try:
        result = _call_ai([
            {"role": "system", "content": SPAM_CHECK_PROMPT_TEMPLATE},
